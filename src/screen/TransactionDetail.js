...
const TransactionDetail = ({route, navigation}) => {
  ...
  const funcCancel = async id => {
    if (trans.status ==='active') {
      const token = (await AsyncStorage.getItem('loginToken'))?.replace(
        /"/g,
        '',
      );
      const config = {
      ...
      try {
        ...
        Alert.alert('Delete transaction successful');
        navigation.goBack();
      } catch (error) {
        console.log('Error cancel transaction: ' + error);
      }
    } else {
        Alert.alert('It is not available')
        navigation.goBack()
    }
  };
    ...
    <SafeAreaView style={styles.layout}>
        ...
        <View>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.info}>
              {trans.customer.name} - {trans.customer.phone}
            </Text>
          </View>
          <View style={styles.row}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.info}>
            {trans.priceBeforePromotion - trans.price}
          </Text>
        </View>
        <View style={styles.line}></View>
        <View style={styles.row}>
